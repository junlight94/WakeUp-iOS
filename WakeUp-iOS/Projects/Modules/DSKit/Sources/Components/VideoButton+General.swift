...
public class VideoButton_General: UIButton {
    let onImage: UIImage?
    ...
    public init() {
        self.onImage = .image(dsimage: .videocamRounded)
        self.offImage = .image(dsimage: .videocamOffRounded)
